...
var open_fullscreen = {
  ...
  message: `
    ...
    （4）在测验过程中不要退出全屏<br/>
    （5）请务必认真作答，主试将对答卷进行核查<br/><br/>
    </b>
    本实验报酬包括：基础被试费1元+认真奖励0~10元+抽取答卷中一次选择*5元<br/>
    <p style="font:25 pt 微软雅黑;text-align: left; color: #B22222">
    您的答卷质量对我们非常重要，也会直接决定您所获得的报酬，请务必认真参与！！<br/>
    <p style="font: 14pt 微软雅黑;line-height: 1.6em">
